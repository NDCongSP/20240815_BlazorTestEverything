...
namespace BlazorAppASM.Pages
{
    public partial class Wms : IDisposable
    {
        ...
        private DotNetObjectReference<Wms>? objRef;
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            using var stream = this.GetType().Assembly.GetManifestResourceStream("BlazorAppASM.resource.wms.svg");
        ...
        private async void RefreshData(object? sender, ElapsedEventArgs e)
        {
            //try
            {
                await _jsRuntime.InvokeVoidAsync("UpdateUIWMS", "Block_C_10_8", _status, Math.Round(_speed, 2));
